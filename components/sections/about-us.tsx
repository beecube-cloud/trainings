...
const AboutSection = ({
  ...
  const images = [
    "/assets/projects/image1.webp",
    "/assets/projects/image12.webp",
    "/assets/projects/image5.webp",
    "/images/courses/img-1.png",
    "/images/courses/img-2.png",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className={`space-y-6 transition-all duration-1000 delay-300 ${
              ...
              <p className={`${textcontent} leading-relaxed`}>
                ...
                from technical skills and project management to construction
                best practice, commissioning and FM—so teams and organisations
            ...
            <div className={`space-y-8 transition-all duration-1000 delay-500 ${
              ...
              <div className="group hover:transform hover:scale-105 transition-all duration-300">
                ...
                <p className={`${textcontent} leading-relaxed group-hover:text-gray-800 transition-colors duration-300`}>
                  To be the leading provider of construction and training services in
                  Nigeria and Africa.
                </p>
              </div>
            </div>
